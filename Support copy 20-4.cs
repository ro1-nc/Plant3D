...
namespace Project1.Support2D
{
    public class SupportC
    {
        ...
        public void DrawSupport20(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HHidBoth, "R");
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"], pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotLB].X, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotLB].X, pointsinfo[Defination.SecBotLB].Y + 500, 0), new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"], pointsinfo[Defination.SecBotLB].Y + 500, 0), SecThick.HidTop, "R");
        ...
        public void DrawSupport21(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), SecThick.HidRight, "R");
