...
namespace Project1.Support2D
{
    public class SupportC
    {
        ...
        public void DRS30(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length * 0.66 + 1000, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.34 + 2000, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.34 + 2000, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.66 + 1000, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HBoth, "l");
        ...
        public void DRS32(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsextrainfo["SRT"].X, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 + height / 2, 0), new Point3d(pointsextrainfo["SRT"].X + length, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 + height / 2, 0), new Point3d(pointsextrainfo["SRT"].X + length, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 - height / 2, 0), new Point3d(pointsextrainfo["SRT"].X, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 - height / 2, 0), SecThick.Nothing, "l", -2000, sectionsize: sectionsize);
        ...
        public void DRS39(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 1500, centerY + 1.1945 * 1000 - 100, 0), "CL.EL.(+)" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 1500, centerY + 1.1945 * 1000 + 300, 0), ListCentalSuppoData[0].ListPrimarySuppo[0].SupportName);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY + height, 0), new Point3d(centerX + length / 2, centerY + height, 0), new Point3d(centerX + length / 2, centerY, 0), new Point3d(centerX - length / 2, centerY, 0), SecThick.HidBottom, "LR");
        ...
        public void DRS40(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecTopRT].X, pointsinfo[Defination.SecTopRT].Y, 0), new Point3d(pointsinfo[Defination.SecTopRT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopRT].Y, 0), new Point3d(pointsinfo[Defination.SecTopRT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopRT].Y - info[Defination.Sec_bot_b], 0), new Point3d(pointsinfo[Defination.SecTopRT].X, pointsinfo[Defination.SecTopRT].Y - info[Defination.Sec_bot_b], 0), SecThick.VHidBoth, "l", 1200);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"], pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotLB].X, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotLB].X, pointsinfo[Defination.SecBotLB].Y + 500, 0), new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"], pointsinfo[Defination.SecBotLB].Y + 500, 0), SecThick.HidTop, "ll");
        ...
        public void DRS42(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] + 1500, centerY - 500 + 0.2 * 1000 - 100, 0), "CL.EL.(+)" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_block_U", centerX, centerY - radius + 0.2 * 1000, radius);
                //height of prim from bottom
                // CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)" + info[Defination.Prim_ht].ToString());
                ...
                //CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius] - 2500, centerY - 500 + 0.2 * 1000 - 100, 0), "CL.EL.(+)" + prim_height);
                LineDraw(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius], centerY - 500 + 0.2 * 1000, 0), new Point3d(centerX - info[Defination.Prim_Radius] - 3000, centerY - 625, 0), MyCol.LightBlue);
                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius] - 2500, centerY - 500 + 0.2 * 1000 + 300, 0), clampname);
