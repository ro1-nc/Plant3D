...
namespace Project1.Support2D
{
    public class SupportC
    {
        ...
        List<string> Checkandgetparllelsupports(ref SupportData SupData)
        {
        ...
        {
            List<string> ListParSup = new List<string>();
            ListParSup = Checkandgetparllelsupports(ref SupData);
        ...
        private void FixCreateBottomSupportTopType2(Document Document2D, BlockTableRecord acadBlockTableRecord, Transaction acadTransaction, Database acadDatabase, double centerX, double centerY, double height, double length, [Optional] int i)
        {
            ...
            dim.Dimclre = Color.FromColor(MyCol.Cyan);
            dim.Dimclrt = Color.FromColor(MyCol.Yellow);
            dim.Dimclrd = Color.FromColor(MyCol.Cyan);
        ...
        public void CreateAlighDimen(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Point3d startpt, Point3d endpt, [Optional] string dimtxt)
        {
            ...
            Line parallelline = CreateParallelLine(startpt, endpt, -1000);
            //dimensioning
            ...
            //align.DimensionStyleName = "ISO-25";
        ...
        public void DrawSupport2(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] + 1500, centerY - 100, 0), "CL.EL.(+)100." + prim_height);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), SecThick.VBoth, "R");
        ...
        public void DrawSupport6(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 500 + info[Defination.Prim_Radius] + 1500, centerY - 100, 0), "CL.EL.(+)100." + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo.Where(e => e.StPt[2] == ListCentalSuppoData[i].ListPrimarySuppo.Min(s => s.StPt[2])).First().SupportName.ToLower().Contains("nb"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 500 + info[Defination.Prim_Radius] + 1500, centerY - 100, 0), "CL.EL.(+)100." + lower_prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo.Where(e => e.StPt[2] == ListCentalSuppoData[i].ListPrimarySuppo.Min(s => s.StPt[2])).First().SupportName.ToLower().Contains("clamp"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 500 + info[Defination.Prim_Radius] - 1500, centerY - info[Defination.Prim_ht] - info[Defination.Sec_bot_b] + extrainfo["Sec_low_b"] + 500 + (radius * 1.5) - 100, 0), "CL.EL.(+)100." + lower_prim_height);
        ...
        public void DrawSupport9(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecTopLB], new Point3d(pointsinfo[Defination.SecTopLB].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLB].Y, pointsinfo[Defination.SecTopLB].Z), new Point3d(pointsinfo[Defination.SecTopLB].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLB].Y - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLB].Z), new Point3d(pointsinfo[Defination.SecTopLB].X, pointsinfo[Defination.SecTopLB].Y - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLB].Z), SecThick.VBoth, "R");
        ...
        public void DrawSupport15(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            string prim_height = "";
            if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListConcreteData.Count > 0)
            {
                //height of prim from bottom
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1000 + info[Defination.Prim_Radius] + 1500, centerY - 100, 0), "CL.EL.(+)100." + prim_height);
        ...
        public void DrawSupport18(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + radius, radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 + info[Defination.Prim_Radius] + 1500, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + radius - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 1500 + extrainfo["sec_Right_Bot_B"] + radius, radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 1500 + extrainfo["sec_Right_Bot_B"] + radius - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
        ...
        public void DrawSupport19(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 3500, 0), new Point3d(pointsinfo[Defination.SecBotRB].X, pointsinfo[Defination.SecBotRB].Y + 3500, 0), SecThick.HBoth, "R");
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"] + radius, radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"] + radius - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_block_U", pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"] + radius, radius);
                //height of prim from bottom
                // CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());

                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                DrawLeader(AcadBlockTableRecord, AcadTransaction, AcadDatabase, clampname, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"] + radius, 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500 - 4 * radius, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Bot_B"] + radius + 1.4 * radius, 0));
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"] + radius, radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"] + radius - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
