...
namespace Project1.Support2D
{
    public class SupportC
    {
        ...
        //aligh dimensioning
        public void CreateAlighDimen(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Point3d startpt, Point3d endpt, [Optional] string dimtxt, double offsetdist = -1000, string dimtype = "hor")
        {
            ...
            try
            {
                ...
                {
                    align.DimensionText = Convert.ToInt32(dimtxt).ToString();
                }
                else
                {
        ...
        public void DrawSupport3(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            CreateAlighDimen(AcadBlockTableRecord, AcadTransaction, new Point3d(centerX + length * 0.34, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.66 + 1737.7464 + 1000, centerY - info[Defination.Sec_ht_top], 0), botsec2, -300);
        ...
        public void DrawSupport19(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + radius, radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + radius - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Lower_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Lower_Bot_B"] + radius, radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Lower_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Lower_Bot_B"] + radius - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
