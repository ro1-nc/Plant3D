    ...
    public class SupportC
    {
        ...
        void Create2DViewWithTemp(Document Document2D)
        {
            ...
            using (Document2D.LockDocument())
            {
                ...
                CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support30");
                // CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support31");
                CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support32");
                // CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support33");
                // CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support34");
                //CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support35");
                //CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support36");
                //CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support37");
                // CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support38");
                CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support39");
                CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support40");
                CreateFullBlock(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, "Support42");
        ...
        private void FixCreateBottomSupportTopType2(Document Document2D, BlockTableRecord acadBlockTableRecord, Transaction acadTransaction, Database acadDatabase, double centerX, double centerY, double height, double length, [Optional] int i)
        {
            ...
            {
                //mtext
                CreateMtextfunc(acadBlockTableRecord, acadTransaction, acadDatabase, new Point3d(centerX + length / 2 + 2500, centerY - ht_frm_cen - height + 300, 0), "HPP.(+)" + ListCentalSuppoData[i].ListConcreteData.Where(e => e.Boundingboxmin.Z == ListCentalSuppoData[i].ListConcreteData.Min(s => s.Boundingboxmin.Z)).First().Boundingboxmin.Z);
        ...
        private void BoxGenCreateSecondarySupportBottom(BlockTableRecord acadBlockTableRecord, Transaction AcadTransaction, Database acadDatabase, Point3d lefttop, Point3d righttop, Point3d rightbot, Point3d leftbot, SecThick secthik, [Optional] string ISMCTAGDir, double verti_tag_offset = 0, double sectionsize = 100)
        {
            ...
            {
                DrawLeader(acadBlockTableRecord, AcadTransaction, acadDatabase, "ISL " + sectionsize, new Point3d(lefttop.X, (lefttop.Y + leftbot.Y) / 2 + verti_tag_offset, 0), new Point3d(lefttop.X - 2000, (lefttop.Y + leftbot.Y) / 2 + verti_tag_offset, 0));
            }
            else if (ISMCTAGDir == "LR" || ISMCTAGDir == "lr")
            {
                DrawLeader(acadBlockTableRecord, AcadTransaction, acadDatabase, "ISL " + sectionsize, new Point3d(righttop.X, (righttop.Y + rightbot.Y) / 2 + verti_tag_offset, 0), new Point3d(righttop.X + 2000, (righttop.Y + rightbot.Y) / 2 + verti_tag_offset, 0));
            }
            //for circular supp
        ...
        public void DRS30(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                info[Defination.Prim_Radius] = radius;
                info[Defination.Prim_ht] = radius;
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Side_Prim_From_End", centerX + 3000 * 0.34 + 2000 + 200, centerY - info[Defination.Prim_ht] - 1000, 500, -Math.PI / 2, new Point3d(centerX + 3000 * 0.34 + 2000 + 200, centerY - info[Defination.Prim_ht] - 1000, 0));
                //height of prim from bottom
                try
                {
                    //    prim_height = MillimetersToMeters(Convert.ToDouble(prim_height)).ToString();
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + oofstlt * 0.34 + info[Defination.Prim_Radius] + 1500, centerY - oofstht - 100, 0), "CL.EL.(+)" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Front_Primary_Elevation", centerX + oofstlt * 0.34 + 2.4 * radius, centerY - oofstht - radius, radius);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length * 0.66 + 1000, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.34 + 2000, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.34 + 2000, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.66 + 1000, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HBoth, "R");
            ...
            //dimensioning
            CreateDimension(new Point3d(pointsinfo[Defination.SecTopRT].X + length, (pointsinfo[Defination.SecTopRT].Y + pointsinfo[Defination.SecTopRB].Y) / 2 + height / 2, 0), new Point3d(centerX + oofstlt * 0.34 + 2.4 * info[Defination.Prim_Radius], centerY - oofstht - info[Defination.Prim_Radius], 0), l_dist_frm_centre.ToString(), text_pos_rotation: -Math.PI / 2);
            CreateDimension(new Point3d(pointsinfo[Defination.SecTopRT].X + length, (pointsinfo[Defination.SecTopRT].Y + pointsinfo[Defination.SecTopRB].Y) / 2 - height / 2, 0), new Point3d(centerX + oofstlt * 0.34 + 2.4 * info[Defination.Prim_Radius], centerY - oofstht - info[Defination.Prim_Radius], 0), r_dist_frm_centre.ToString(), text_pos_rotation: -Math.PI / 2);
        ...
        public void DRS32(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                length = 200;
                BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY + radius, 0), new Point3d(centerX + length / 2, centerY + radius, 0), new Point3d(centerX + length / 2, centerY - 1.4 * radius, 0), new Point3d(centerX - length / 2, centerY - 1.4 * radius, 0), SecThick.HBoth, "R", 0, sectionsize);
            ...
            CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_block_U", centerX, centerY - info[Defination.Prim_ht], 1000);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsextrainfo["SRT"].X, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 + height / 2, 0), new Point3d(pointsextrainfo["SRT"].X + length, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 + height / 2, 0), new Point3d(pointsextrainfo["SRT"].X + length, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 - height / 2, 0), new Point3d(pointsextrainfo["SRT"].X, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 - height / 2, 0), SecThick.VBoth, "l", -2000, sectionsize: sectionsize);

            pointsextrainfo["RT"] = new Point3d(pointsextrainfo["SRT"].X, (pointsextrainfo["SRT"].Y + pointsextrainfo["SRB"].Y) / 2 + height / 2, 0);
        ...
        public void DRS34(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            var sectionsize = Convert.ToDouble(CSECTIONSIZE(secsupp_des.ElementAt(0).Size));
        ...
        public void DRS35(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            try
            {
                var strpt = GetArrayAbsoluteValues(ListCentalSuppoData[i].ListSecondrySuppo.Where(e => e.PartDirection == "Hor").First().StPt);
                var endpt = GetArrayAbsoluteValues(ListCentalSuppoData[i].ListSecondrySuppo.Where(e => e.PartDirection == "Hor").First().EndPt);
                var midpt = Get3dAbsoluteValues(ListCentalSuppoData[i].ListPrimarySuppo[0].Centroid);
        ...
        public void DRS38(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 - info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y, 0), new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 + info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y, 0), new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 + info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y - info[Defination.Concrete_b], 0), new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 - info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y - info[Defination.Concrete_b], 0), SecThick.Nothing, "l", -2000, sectionsize: sectionsize);
            //if (ListCentalSuppoData[i].ListConcreteData.Count > 0)
            //{
            //    FixCreateBottomSupportTopType2(Document2D, AcadBlockTableRecord, AcadTransaction, AcadDatabase, centerX, centerY, height, length, i);
            //}
        ...
        public void DRS39(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, centerX, centerY, 801.5625);
                //height of prim from bottom
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_With_V_ANGLE", centerX, centerY, radius);
            ...
            length = 4000;
            height = 1.46 * radius;
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY + height, 0), new Point3d(centerX + length / 2, centerY + height, 0), new Point3d(centerX + length / 2, centerY, 0), new Point3d(centerX - length / 2, centerY, 0), SecThick.Nothing, "LR");
            ...
            height = radius;
            length = 200;
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY, 0), new Point3d(centerX + length / 2, centerY, 0), new Point3d(centerX + length / 2, centerY - height, 0), new Point3d(centerX - length / 2, centerY - height, 0), SecThick.Nothing);
            ...
            CreateDimension(pointsextrainfo["LT"], new Point3d(centerX, centerY, 0), l_dist_frm_centre.ToString());
            CreateDimension(pointsextrainfo["RT"], new Point3d(centerX, centerY, 0), r_dist_frm_centre.ToString());
        ...
        public void DRS40(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X - 1500, pointsinfo[Defination.SecBotRB].Y + 1500 + extrainfo["sec_Right_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 1500 + extrainfo["sec_Right_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 1500, 0), new Point3d(pointsinfo[Defination.SecBotRB].X - 1500, pointsinfo[Defination.SecBotRB].Y + 1500, 0), SecThick.HBoth, "R");
        ...
        public void DRS42(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                info[Defination.Prim_ht] = radius;
                //FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, centerX, centerY, 801.5625);
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_Side_View", centerX, centerY - 625, radius);
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] + 1500, centerY - 625 - 100, 0), "CL.EL.(+)" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_block_U", centerX, centerY - 625, radius);
                //height of prim from bottom
                // CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)" + info[Defination.Prim_ht].ToString());
                ...
                //CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius] - 2500, centerY - 625 - 100, 0), "CL.EL.(+)" + prim_height);
                LineDraw(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius], centerY - 625, 0), new Point3d(centerX - info[Defination.Prim_Radius] - 3000, centerY - 625, 0), MyCol.LightBlue);
                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius] - 2500, centerY - 625 + 300, 0), clampname);
            ...
            //sec bot
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2 - 1000, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2 - 1000, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2 - 1000, centerY - info[Defination.Sec_ht_top] - height, 0), new Point3d(centerX - length / 2 - 1000, centerY - info[Defination.Sec_ht_top] - height, 0), SecThick.Right, "l");
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                info[Defination.Prim_ht] = radius;
                //FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, centerX, centerY, 801.5625);
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_With_V_ANGLE", centerX, centerY - 500, radius);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_With_V_ANGLE", centerX - 500, centerY, radius);
                //height of prim from bottom
                // CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)" + info[Defination.Prim_ht].ToString());
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length / 2, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HidTop, "R", 0, sectionsize);
