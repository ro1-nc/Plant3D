    ...
    public class SupportC
    {
        ...
        public void CreateFullBlock(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            else if (SupType == SupportType.Support20.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport20(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
            ...
            else if (SupType == SupportType.Support21.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport21(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
            ...
            else if (SupType == SupportType.Support23.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport23(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
            ...
            else if (SupType == SupportType.Support24.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport24(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
            ...
            else if (SupType == SupportType.Support25.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport25(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
            ...
            else if (SupType == SupportType.Support26.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport26(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
            ...
            else if (SupType == SupportType.Support27.ToString())
            {
                ...
                if (spaceY > boxht)
                {
                    DrawSupport27(AcadBlockTableRecord, AcadTransaction, AcadDatabase, ref tracex, boxlen, boxht, ref spaceY, Document2D, ListCentalSuppoData[i].SupportType, i);
                }
                else
                {
        ...
        public void CreateDimension(Point3d strpt, Point3d endpt, [Optional] string topsec, double vertical_offset = 1800)
        {
        ...
        private void BoxGenCreateSecondarySupportBottom(BlockTableRecord acadBlockTableRecord, Transaction AcadTransaction, Database acadDatabase, Point3d lefttop, Point3d righttop, Point3d rightbot, Point3d leftbot, SecThick secthik, [Optional] string ISMCTAGDir, double verti_tag_offset = 0)
        {
            ...
            {
                DrawLeader(acadBlockTableRecord, AcadTransaction, acadDatabase, "ISMC 100", new Point3d(lefttop.X, (lefttop.Y + leftbot.Y) / 2 + verti_tag_offset, 0), new Point3d(lefttop.X - 2000, (lefttop.Y + leftbot.Y) / 2 + verti_tag_offset, 0));
            }
            if (ISMCTAGDir == "R" || ISMCTAGDir == "r")
            {
                DrawLeader(acadBlockTableRecord, AcadTransaction, acadDatabase, "ISMC 100", new Point3d(righttop.X, (righttop.Y + rightbot.Y) / 2 + verti_tag_offset, 0), new Point3d(righttop.X + 2000, (righttop.Y + rightbot.Y) / 2 + verti_tag_offset, 0));
            }
        ...
        public void DrawSupport3(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            try
            {
                ...
                var sectionsize = CSECTIONSIZE(ListCentalSuppoData[i].ListSecondrySuppo.Where(e => e.PartDirection == "45Inclined").First().Size);
        ...
        public void DrawSupport6(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                //CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 500 + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 500 + info[Defination.Prim_Radius] + 2500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo.Where(e => e.StPt[2] == ListCentalSuppoData[i].ListPrimarySuppo.Min(s => s.StPt[2])).First().SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 500 - info[Defination.Prim_Radius] - 2500, centerY - info[Defination.Prim_ht] - info[Defination.Sec_bot_b] + extrainfo["Sec_low_b"] + 500 + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            CreateDimension(pointsextrainfo["Sec_low_LT"], new Point3d(centerX - 500, pointsextrainfo["Sec_low_LT"].Y + info[Defination.Prim_ht], 0), l_dist_frm_centre.ToString(), 200);
            CreateDimension(pointsextrainfo["Sec_low_RT"], new Point3d(centerX - 500, pointsextrainfo["Sec_low_LT"].Y + info[Defination.Prim_ht], 0), r_dist_frm_centre.ToString(), 200);
        ...
        public void DrawSupport13(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius] - 2500, centerY - 100, 0), "CL.EL.(+)10");
                LineDraw(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius], centerY, 0), new Point3d(centerX + info[Defination.Prim_Radius] - 3000, centerY, 0), MyCol.LightBlue);
                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - info[Defination.Prim_Radius] - 2500, centerY + 300, 0), clampname);
        ...
        public void DrawSupport15(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1000 - info[Defination.Prim_Radius] - 2500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 3500, centerY - info[Defination.Prim_ht] + 300, 0), "TOS EL.(+)10" + TotalHt);
        ...
        public void DrawSupport18(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 - info[Defination.Prim_Radius] - 1500, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 - info[Defination.Prim_Radius] - 2500, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + radius - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 1500, pointsinfo[Defination.SecBotRB].Y + 1500 + extrainfo["sec_Right_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 2500, pointsinfo[Defination.SecBotRB].Y + 1500 + extrainfo["sec_Right_Bot_B"] + radius - 100, 0), "CL.EL.(+)10" + prim_height);
        ...
        public void DrawSupport19(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HBoth, "l");
            ...
            //dimensioning
            CreateDimension(new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX, centerY + info[Defination.Prim_Radius], 0), l_dist_frm_centre.ToString(), 1000);
            CreateDimension(new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX, centerY + info[Defination.Prim_Radius], 0), r_dist_frm_centre.ToString(), 1000);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000, pointsinfo[Defination.SecBotLT].Y - 1000 + (radius * 1.5), radius);
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 + info[Defination.Prim_Radius] + 1500, pointsinfo[Defination.SecBotLT].Y - 1000 + (radius * 1.5) - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLT].X - extrainfo["sec_Left_Bot_L"] + 1000 - info[Defination.Prim_Radius] - 2500, pointsinfo[Defination.SecBotLT].Y - 1000 + radius - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            CreateDimension(new Point3d(pointsinfo[Defination.SecBotLT].X, pointsinfo[Defination.SecBotLT].Y - 1000, 0), new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000, pointsinfo[Defination.SecBotLT].Y - 1000 + (info[Defination.Prim_Radius] * 1.5) + info[Defination.Prim_Radius], 0), r_dist_frm_centre.ToString(), 200);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 2500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + radius - 100, 0), "CL.EL.(+)10" + prim_height);
                LineDraw(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + info[Defination.Prim_Radius], pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + radius, 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 3000, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + radius, 0), MyCol.LightBlue);
                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 2500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + radius + 300, 0), clampname);

            }

            //right hori dimen of prim and sec
            l_dist_frm_centre = 0;
            r_dist_frm_centre = 0;
            //dimensioning
            try
            ...
            //dimensioning
            CreateDimension(new Point3d(pointsinfo[Defination.SecBotRB].X, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + (info[Defination.Prim_Radius] * 1.5) + info[Defination.Prim_Radius], 0), l_dist_frm_centre.ToString(), 200);
            CreateDimension(new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + (info[Defination.Prim_Radius] * 1.5) + info[Defination.Prim_Radius], 0), r_dist_frm_centre.ToString(), 200);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Lower_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 2500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Lower_Bot_B"] + radius - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            CreateDimension(new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Lower_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Lower_Bot_B"], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Lower_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Lower_Bot_B"] + (info[Defination.Prim_Radius] * 1.5) + info[Defination.Prim_Radius], 0), r_dist_frm_centre.ToString(), 1000);
        ...
        [Obsolete]
        public void DrawSupport20(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            double upperYgap = 3500;
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.66, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.34, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HHidBoth, "l");
            ...
            CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 4500, centerY - info[Defination.Prim_ht] + 300, 0), "TOS EL.(+)10" + TotalHt);
        ...
        [Obsolete]
        public void DrawSupport21(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
        ...
        public void DrawSupport22(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500 - 2000, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 2500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"] + radius - 100, 0), "CL.EL.(+)10" + prim_height);
        ...
        [Obsolete]
        public void DrawSupport23(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                // CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 3500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 1000 - info[Defination.Prim_Radius] - 2500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                LineDraw(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 1000 - info[Defination.Prim_Radius], centerY, 0), new Point3d(centerX + 1000 - info[Defination.Prim_Radius] - 3000, centerY, 0), MyCol.LightBlue);
                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + 1000 - info[Defination.Prim_Radius] - 2500, centerY + 300, 0), clampname);
            ...
            //upper secondary supp
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length / 2, centerY - info[Defination.Prim_ht] - height, 0), SecThick.Nothing, "R");
            ...
            CreateDimension(pointsinfo[Defination.SecTopLT], new Point3d(centerX + 1000, centerY + info[Defination.Prim_Radius], 0), l_dist_frm_centre.ToString());
            CreateDimension(new Point3d(centerX + 1000, centerY + info[Defination.Prim_Radius], 0), pointsinfo[Defination.SecTopRT], r_dist_frm_centre.ToString());
        ...
        [Obsolete]
        public void DrawSupport24(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
        ...
        [Obsolete]
        public void DrawSupport25(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            double upperYgap = 3500;
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecTopRT].X - info[Defination.Sec_bot_l] - 500, pointsinfo[Defination.SecTopRT].Y + 500, 0), new Point3d(pointsinfo[Defination.SecTopRT].X - 500, pointsinfo[Defination.SecTopRT].Y + 500, 0), new Point3d(pointsinfo[Defination.SecTopRT].X - 500, pointsinfo[Defination.SecTopRT].Y + 500 - info[Defination.Sec_bot_b], 0), new Point3d(pointsinfo[Defination.SecTopRT].X - info[Defination.Sec_bot_l] - 500, pointsinfo[Defination.SecTopRT].Y + 500 - info[Defination.Sec_bot_b], 0), SecThick.VBoth, "l");

            //info for future
            pointsinfo[Defination.SecBotLT] = new Point3d(pointsinfo[Defination.SecTopRT].X - info[Defination.Sec_bot_l] - 500, pointsinfo[Defination.SecTopRT].Y + 500, 0);
            pointsinfo[Defination.SecBotRT] = new Point3d(pointsinfo[Defination.SecTopRT].X - 500, pointsinfo[Defination.SecTopRT].Y + 500, 0);
            pointsinfo[Defination.SecBotRB] = new Point3d(pointsinfo[Defination.SecTopRT].X - 500, pointsinfo[Defination.SecTopRT].Y + 500 - info[Defination.Sec_bot_b], 0);
            pointsinfo[Defination.SecBotLB] = new Point3d(pointsinfo[Defination.SecTopRT].X - info[Defination.Sec_bot_l] - 500, pointsinfo[Defination.SecTopRT].Y + 500 - info[Defination.Sec_bot_b], 0);
            //dimensioning
            var botsec = "";
            try
            {
        ...
        [Obsolete]
        public void DrawSupport26(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            double upperYgap = 3500;
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecTopLT].X, pointsinfo[Defination.SecTopLT].Y + 500, 0), new Point3d(pointsinfo[Defination.SecTopLT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500, pointsinfo[Defination.SecTopLT].Z), new Point3d(pointsinfo[Defination.SecTopLT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z), new Point3d(pointsinfo[Defination.SecTopLT].X, pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z), SecThick.VBoth, "l");

            //info for future
            pointsinfo[Defination.SecBotLT] = new Point3d(pointsinfo[Defination.SecTopLT].X, pointsinfo[Defination.SecTopLT].Y + 500, 0);
            pointsinfo[Defination.SecBotRT] = new Point3d(pointsinfo[Defination.SecTopLT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500, pointsinfo[Defination.SecTopLT].Z);
            pointsinfo[Defination.SecBotRB] = new Point3d(pointsinfo[Defination.SecTopLT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z);
            pointsinfo[Defination.SecBotLB] = new Point3d(pointsinfo[Defination.SecTopLT].X - info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z);
            //dimensioning
        ...
        [Obsolete]
        public void DrawSupport27(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, centerX - 1200, centerY, 801.5625);
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1200 + info[Defination.Prim_Radius] + 1500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Prim_block_U", centerX - 1200, centerY, radius);
                //height of prim from bottom
                // CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
                ...
                //CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1200 - info[Defination.Prim_Radius] - 2500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                LineDraw(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1200 - info[Defination.Prim_Radius], centerY, 0), new Point3d(centerX - 1200 - info[Defination.Prim_Radius] - 3000, centerY, 0), MyCol.LightBlue);
                string clampname = ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName;
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1200 - info[Defination.Prim_Radius] - 2500, centerY + 300, 0), clampname);
            ...
            try
            {
                ...
                l_dist_frm_centre = Math.Round(GetDist(new Point3d(strpt), projectedpt));
                mid_dist_frm_centre = Math.Round(GetDist(new Point3d(strpt), projectedpt));
                r_dist_frm_centre = Math.Round(GetDist(new Point3d(endpt), projectedpt));
            }
            catch (Exception)
            {
            ...
            CreateDimension(pointsinfo[Defination.SecTopLT], new Point3d(centerX - 1200, centerY + info[Defination.Prim_Radius], 0), l_dist_frm_centre.ToString());
            CreateDimension(new Point3d(centerX - 1200, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + 1200, centerY + info[Defination.Prim_Radius], 0), mid_dist_frm_centre.ToString());
            CreateDimension(new Point3d(centerX + 1200, centerY - info[Defination.Prim_ht], 0), pointsinfo[Defination.SecTopRT], r_dist_frm_centre.ToString());
