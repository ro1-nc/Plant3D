...
            List<SupporSpecData> ListAllSuppoData = new List<SupporSpecData>();
        ...
        void GetRotationNBParts(BlockReference BlockRef, ref SupporSpecData SuppoSpecdata)
        {
            ...
            foreach (Entity AcEnt1 in ExpObjs)
            {
                ...
                double Vol = BoxData.X * BoxData.Y * BoxData.Z;
                ...
                if (CombinedParSupp[0].Count == 3 || CombinedParSupp[0].Count == 1 || CombinedParSupp[1].Count == 3 || CombinedParSupp[1].Count == 1)
                {
                    ...
                    if (Count1 == 2 && Count2 == 1)
                    {
                        foreach (var SecData in SupData.ListSecondrySuppo)
                        {
                            ...
                            {
                                if (PsuppoData.TouchingPartid != null && ProecessedPids != null)
                                {
        ...
        public void CreateSupportName(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, int i)
        {
            ...
            CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 1500 + 1000, spaceY - boxht + 700 + 1100 - 100, 0), ListCentalSuppoData[i].SupportType, 350, MyCol.Red);
        ...
        public void DRS2(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            try
            {
                if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
                {
                    ...
                    prim_height = Math.Round((MillimetersToMeters(ListCentalSuppoData[i].ListPrimarySuppo[0].Centroid.Z) - datum_level), 2).ToString();
                }
            ...
            var section = ListCentalSuppoData[i].ListSecondrySuppo.Where(e => e.Centroid.Z == ListCentalSuppoData[i].ListSecondrySuppo.Max(s => s.Centroid.Z)).First().Size;
            ...
            try
            {
                TotalHt = Math.Round(MillimetersToMeters(ListCentalSuppoData[i].ListSecondrySuppo.Where(e => e.PartDirection.ToLower() == "hor").First().Boundingboxmax.Z) - datum_level, 2).ToString();
            }
            catch (Exception)
            {
            }
        ...
        public void DRS6(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            var primsupp_des = ListCentalSuppoData[i].ListPrimarySuppo.OrderByDescending(e => e.Centroid.Z);
            var secsupp_des = ListCentalSuppoData[i].ListPrimarySuppo.OrderByDescending(e => e.Boundingboxmax.Z);
            ...
            try
            {
                if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
                {
                    ...
                    prim_height = Math.Round((MillimetersToMeters(primsupp_des.ElementAt(0).Centroid.Z) - datum_level), 2).ToString();
                }
            ...
            try
            {
                TotalHt = Math.Round(MillimetersToMeters(secsupp_des.ElementAt(0).Boundingboxmax.Z) - datum_level, 2).ToString();
            }
            catch (Exception)
            {
            }
            ...
            try
            {
                TotalHt = Math.Round(MillimetersToMeters(secsupp_des.ElementAt(1).Boundingboxmax.Z) - datum_level, 2).ToString();
            }
            catch (Exception)
            {
            }
            CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Sec_top_l] * 0.34 - extrainfo["Sec_low_l"] - 3500, centerY - info[Defination.Prim_ht] - info[Defination.Sec_bot_b] + extrainfo["Sec_low_b"] + 500 + 300, 0), "TOS EL.(+)10" + TotalHt);
            ...
            try
            {
                if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
                {
                    ...
                    lower_prim_height = Math.Round((MillimetersToMeters(primsupp_des.ElementAt(1).Centroid.Z) - datum_level), 2).ToString();
                }
        ...
        public void DRS18(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            try
            {
                TotalHt = Math.Round(MillimetersToMeters(secsupp_des.ElementAt(2).Boundingboxmax.Z) - datum_level, 2).ToString();
            }
            catch (Exception)
            {
            }
            ...
            try
            {
                if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
                {
                    ...
                    prim_height = Math.Round((MillimetersToMeters(primsupp_des.ElementAt(2).Centroid.Z) - datum_level), 2).ToString();
                }
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 - info[Defination.Prim_Radius] - 2000, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            try
            {
                if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
                {
                    ...
                    prim_height = Math.Round((MillimetersToMeters(primsupp_des.ElementAt(1).Centroid.Z) - datum_level), 2).ToString();
                }
        ...
        public void DRS19(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 - info[Defination.Prim_Radius] - 2500, pointsinfo[Defination.SecBotLT].Y - 1000 + (radius * 1.5) - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + 1000, pointsinfo[Defination.SecBotRB].Y + 3500 + extrainfo["sec_Right_Upper_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Lower_Bot_L"] - 1500 + 1000, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Lower_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
        ...
        public void DRS22(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            CreateDimension(new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"] + (info[Defination.Prim_Radius] * 1.5) + info[Defination.Prim_Radius], 0), new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"], pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"], 0), r_dist_frm_centre.ToString(), 1000);
        ...
        public void DRS26(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            pointsinfo[Defination.SecBotLB] = new Point3d(pointsinfo[Defination.SecTopLT].X, pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z);
            //dimensioning
        ...
        public void DRS27(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 2200 - info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                //CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 2200 - info[Defination.Prim_Radius] - 2500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            CreateDimension(new Point3d(centerX - 2200, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + 2200, centerY + info[Defination.Prim_Radius], 0), mid_dist_frm_centre.ToString());
            CreateDimension(new Point3d(centerX + 2200, centerY - info[Defination.Prim_ht], 0), pointsinfo[Defination.SecTopRT], r_dist_frm_centre.ToString());
        ...
        public void DRS28(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            info[Defination.Sec_ht_top] = info[Defination.Prim_ht] + height;
            //sec bot
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), SecThick.VBoth, "none");
        ...
        public void DRS29(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            //sec bot
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotLT].Y + height, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotLT].Y + height, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotLT].Y, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotLT].Y, 0), SecThick.VBoth, "none");
