...
            List<SupporSpecData> ListAllSuppoData = new List<SupporSpecData>();
        ...
        private void BoxGenCreateSecondarySupportBottom(BlockTableRecord acadBlockTableRecord, Transaction AcadTransaction, Database acadDatabase, Point3d lefttop, Point3d righttop, Point3d rightbot, Point3d leftbot, SecThick secthik, [Optional] string ISMCTAGDir, double verti_tag_offset = 0, double sectionsize = 100)
        {
            ...
            if (ISMCTAGDir == "NBL" || ISMCTAGDir == "nbl")
            {
            ...
            if (ISMCTAGDir == "NBR" || ISMCTAGDir == "nbr")
            {
        ...
        public void TOSLOC(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, double centerX, double centerY, string TotalHt, string position = "r")
        {

            if (position.ToLower() == "l")
            {
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 3500, centerY + 300, 0), "TOS EL.(+)" + TotalHt);
        ...
        public void DRS2(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            var secsupp_des = ListCentalSuppoData[i].ListSecondrySuppo.Where(e => e.PartDirection == "hor").OrderByDescending(e => e.Boundingboxmax.Z);
        ...
        public void DRS19(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + 1000, pointsinfo[Defination.SecBotRB].Y + 4000 + extrainfo["sec_Right_Upper_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)100." + info[Defination.Prim_ht].ToString());
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Upper_Bot_L"] - 1500 + info[Defination.Prim_Radius] + 2500, pointsinfo[Defination.SecBotRB].Y + 4000 + extrainfo["sec_Right_Upper_Bot_B"] + radius - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            try
            {
                TotalHt = Math.Round(MillimetersToMeters(secsupp_des.ElementAt(3).Boundingboxmax.Z) - datum_level, 2).ToString();
            }
            catch (Exception)
            {
            }
            ...
            try
            {
                if (ListCentalSuppoData[i].ListPrimarySuppo.Count > 0 && ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
                {
                    ...
                    prim_height = Math.Round((MillimetersToMeters(primsupp_des.ElementAt(3).Centroid.Z) - datum_level), 2).ToString();
                }
        ...
        public void DRS22(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRB].X + extrainfo["sec_Right_Bot_L"] - 1500 + 3000, pointsinfo[Defination.SecBotRB].Y + 500 + extrainfo["sec_Right_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
        ...
        public void DRS25(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecTopRT].X - info[Defination.Sec_bot_l] - 500, pointsinfo[Defination.SecTopRT].Y + 500, 0), new Point3d(pointsinfo[Defination.SecTopRT].X - 500, pointsinfo[Defination.SecTopRT].Y + 500, 0), new Point3d(pointsinfo[Defination.SecTopRT].X - 500, pointsinfo[Defination.SecTopRT].Y + 500 - info[Defination.Sec_bot_b], 0), new Point3d(pointsinfo[Defination.SecTopRT].X - info[Defination.Sec_bot_l] - 500, pointsinfo[Defination.SecTopRT].Y + 500 - info[Defination.Sec_bot_b], 0), SecThick.VBoth, "nbl");
        ...
        public void DRS26(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecTopLT].X, pointsinfo[Defination.SecTopLT].Y + 500, 0), new Point3d(pointsinfo[Defination.SecTopLT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500, pointsinfo[Defination.SecTopLT].Z), new Point3d(pointsinfo[Defination.SecTopLT].X + info[Defination.Sec_bot_l], pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z), new Point3d(pointsinfo[Defination.SecTopLT].X, pointsinfo[Defination.SecTopLT].Y + 500 - info[Defination.Sec_bot_b], pointsinfo[Defination.SecTopLT].Z), SecThick.VBoth, "nbl", -1000);
        ...
        public void DRS27(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("clamp"))
            {
                ...
                //CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX + info[Defination.Prim_Radius] - 1500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - 2200 - info[Defination.Prim_Radius] - 3500, centerY - 100, 0), "CL.EL.(+)10" + prim_height);
            ...
            CreateDimension(pointsinfo[Defination.SecTopRT], new Point3d(centerX + 2200, centerY - info[Defination.Prim_ht], 0), r_dist_frm_centre.ToString());
            ...
            length = 1000;
            info[Defination.Sec_ht_bot] = info[Defination.Sec_ht_top] + height;
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top], 0), new Point3d(centerX + length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), new Point3d(centerX - length / 2, centerY - info[Defination.Sec_ht_top] - height, 0), SecThick.Left, "nbl");
        ...
        public void DRS29(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                FixCreatePrimarySupportwithvertex(AcadBlockTableRecord, AcadTransaction, AcadDatabase, pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + (radius * 1.5), radius, "l");
                //height of prim from bottom
                CreateMtextfunc(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLB].X - extrainfo["sec_Left_Bot_L"] + 1000 - info[Defination.Prim_Radius] - 2500, pointsinfo[Defination.SecBotLB].Y + 500 + extrainfo["sec_Left_Bot_B"] + (radius * 1.5) - 100, 0), "CL.EL.(+)10" + prim_height);
        ...
        public void DRS31(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            length = 1000;
            info[Defination.Sec_ht_bot] = +height;
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotLT].X - length, pointsinfo[Defination.SecBotLT].Y, 0), new Point3d(pointsinfo[Defination.SecBotLT].X, pointsinfo[Defination.SecBotLT].Y, 0), new Point3d(pointsinfo[Defination.SecBotLT].X, pointsinfo[Defination.SecBotLT].Y - height, 0), new Point3d(pointsinfo[Defination.SecBotLT].X - length, pointsinfo[Defination.SecBotLT].Y - height, 0), SecThick.VBoth, "R");

            pointsinfo[Defination.SecBotLT] = new Point3d(pointsinfo[Defination.SecBotLT].X - length, pointsinfo[Defination.SecBotLT].Y, 0);
            pointsinfo[Defination.SecBotRT] = new Point3d(pointsinfo[Defination.SecBotLT].X, pointsinfo[Defination.SecBotLT].Y, 0);
            pointsinfo[Defination.SecBotRB] = new Point3d(pointsinfo[Defination.SecBotLT].X, pointsinfo[Defination.SecBotLT].Y - height, 0);
            pointsinfo[Defination.SecBotLB] = new Point3d(pointsinfo[Defination.SecBotLT].X - length, pointsinfo[Defination.SecBotLT].Y - height, 0);
            ...
            CreateAlighDimen(AcadBlockTableRecord, AcadTransaction, pointsinfo[Defination.SecBotLT], pointsinfo[Defination.SecBotRT], botsec, 1000);
