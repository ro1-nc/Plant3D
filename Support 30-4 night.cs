    ...
    public class SupportC
    {
        ...
        public void DRS30(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                info[Defination.Prim_Radius] = radius;
                info[Defination.Prim_ht] = radius;
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Front_Primary_Elevation", centerX + oofstlt * 0.34 + 2.4 * radius + 1000, centerY - oofstht - radius, 500, -Math.PI / 2, new Point3d(centerX + oofstlt * 0.34 + 2.4 * radius, centerY - oofstht - radius, 0));
                //height of prim from bottom
                try
                {
                    //    prim_height = MillimetersToMeters(Convert.ToDouble(prim_height)).ToString();
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(centerX - length * 0.66 + 2000, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.34 + 2000, centerY - info[Defination.Prim_ht], 0), new Point3d(centerX + length * 0.34 + 2000, centerY - info[Defination.Prim_ht] - height, 0), new Point3d(centerX - length * 0.66 + 2000, centerY - info[Defination.Prim_ht] - height, 0), SecThick.HBoth, "R");
        ...
        public void DRS32(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - 500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - 500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - 500 - height, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - 500 - height, 0), SecThick.VBoth, "l", -2000, sectionsize: sectionsize);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0), SecThick.VBoth, "l", -2000, sectionsize: sectionsize);
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d(pointsinfo[Defination.SecBotRT].X, pointsinfo[Defination.SecBotRT].Y - 2500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0), SecThick.VBoth, "l", -2000, sectionsize: sectionsize);

            //front side view of prim and plate view
            height = 1500;
            length = 200;

            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + 3000 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + 3000 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + 3000 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0), new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + 3000 - length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0), SecThick.VBoth, "l", -2000, sectionsize: sectionsize);

            pointsextrainfo["RT"] = new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + 3000 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500, 0);
            pointsextrainfo["RB"] = new Point3d((pointsinfo[Defination.SecBotLT].X + pointsinfo[Defination.SecBotRT].X) / 2 + 3000 + length / 2, pointsinfo[Defination.SecBotRT].Y - 2500 - height, 0);
            ...
            if (ListCentalSuppoData[i].ListPrimarySuppo[0].SupportName.ToLower().Contains("nb"))
            {
                ...
                info[Defination.Prim_Radius] = radius;
                info[Defination.Prim_ht] = radius;
                CopyAndModifyEntities(AcadBlockTableRecord, AcadTransaction, AcadDatabase, "Front_Primary_Elevation", pointsextrainfo["RT"].X + 2.4 * radius, (pointsextrainfo["RT"].Y + pointsextrainfo["RB"].Y) / 2, 500, -Math.PI / 2, new Point3d(pointsextrainfo["RT"].X + 2.4 * radius, (pointsextrainfo["RT"].Y + pointsextrainfo["RB"].Y) / 2, 0));
                //height of prim from bottom
                try
                {
                    //    prim_height = MillimetersToMeters(Convert.ToDouble(prim_height)).ToString();
        ...
        public void DRS37(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            CreateAlighDimen(AcadBlockTableRecord, AcadTransaction, new Point3d(pointsinfo[Defination.SecTopRT].X, pointsinfo[Defination.SecTopRT].Y, 0), new Point3d(pointsinfo[Defination.SecTopRT].X, pointsinfo[Defination.SecTopRT].Y + height, 0), botsec, -500);
        ...
        public void DRS38(BlockTableRecord AcadBlockTableRecord, Transaction AcadTransaction, Database AcadDatabase, ref double tracex, double boxlen, double boxht, ref double spaceY, Document Document2D, string SupType, [Optional] int i)
        {
            ...
            BoxGenCreateSecondarySupportBottom(AcadBlockTableRecord, AcadTransaction, AcadDatabase, new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 - info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y, 0), new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 + info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y, 0), new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 + info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y - info[Defination.Concrete_b], 0), new Point3d((pointsinfo[Defination.SecBotLB].X + pointsinfo[Defination.SecBotRB].X) / 2 - info[Defination.Concrete_l] / 2, pointsinfo[Defination.SecBotRB].Y - info[Defination.Concrete_b], 0), SecThick.VBoth, "l", -2000, sectionsize: sectionsize);
            //if (ListCentalSuppoData[i].ListConcreteData.Count > 0)
            //{
            //    FixCreateBottomSupportTopType2(Document2D, AcadBlockTableRecord, AcadTransaction, AcadDatabase, centerX, centerY, height, length, i);
            //}
